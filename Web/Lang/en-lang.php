<?php
  ...
  define('TXT_TERMS_USE', 'Terms of use');
  //Purchase.php
  define('TXT_TITLE_BUY','HappyDawn - Purchase');
  define('TXT_HOME_BUTTON', 'Back to homepage');
  define('TXT_BUY_CLOCK', 'Buy our alarm clock');
  define('TXT_NUMBER_CLOCK', 'Number of alarm clocks(1-10)');
  define('TXT_ADDRESS', 'Address (Street, n°)');
